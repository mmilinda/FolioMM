        ...
        >
          ...
          <div className="lg:col-span-6 flex flex-col justify-between space-y-4 text-left">
            <div className="space-y-3">
              ...
              {/* Glass Card Box */}
              <div className="p-4 sm:p-5 rounded-xl bg-slate-900/90 border border-cyan-400/35 backdrop-blur-xl space-y-2 shadow-lg relative overflow-hidden">
              ...
              {/* Paragraphs */}
              <div className="space-y-3 text-xs sm:text-base leading-relaxed text-slate-300">
                <p className="m-0">
          ...
          <div className="lg:col-span-6 flex">
            ...
            >
              <div className="space-y-3 flex-grow flex flex-col justify-between">
                ...
                <div className="w-full h-24 sm:h-28 rounded-xl overflow-hidden border border-white/15 relative shadow-sm shrink-0">
                  <img src="/initiatives_banner.jpg" alt="Leadership Tech" className="w-full h-full object-cover" />
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/20 to-transparent" />
                  <div className="absolute bottom-2 left-2.5 flex items-center gap-1.5">
                    <span className="px-2.5 py-0.5 rounded bg-cyan-400 text-slate-950 text-xs font-black uppercase tracking-wider shadow-sm flex items-center gap-1">
                ...
                <div className="flex items-center gap-2.5 border-b border-white/10 pb-2 shrink-0">
                  ...
                  <div>
                    ...
                    <span className="text-xs text-slate-400 mt-0.5 inline-block">Initiatives & Leadership</span>
                  </div>
                </div>
                ...
                <div className="flex flex-col justify-between space-y-2 w-full flex-grow my-auto">
                  {initiatives.map((item) => (
                    <motion.div
                      key={item.text}
                      whileHover={{ x: 3 }}
                      className="flex items-center gap-2.5 px-3.5 py-2 sm:py-2.5 rounded-xl bg-white/5 border border-white/10 text-slate-200 text-xs sm:text-sm font-semibold w-full hover:bg-white/10 hover:border-cyan-400/40 transition-all shadow-xs min-h-[36px] sm:min-h-[40px]"
                    >
              ...
              {/* Bottom Ambition Box */}
              <div className="p-3 sm:p-3.5 rounded-xl bg-gradient-to-r from-cyan-950/80 via-slate-900/90 to-indigo-950/80 border border-cyan-400/35 shadow-md space-y-1 shrink-0">
                <span className="text-xs uppercase tracking-wider font-black text-cyan-400 flex items-center gap-1.5">
            ...
            {impactDomains.map((item) => {
              ...
              return (
                <motion.div
                  ...
                  className={`p-3.5 rounded-xl border ${item.border} bg-slate-900/90 backdrop-blur-md flex flex-col justify-between space-y-2 text-left shadow-md hover:shadow-lg transition-all min-h-[140px] sm:min-h-[155px] h-full`}
                ...
                >
                  ...
                  <p className="text-xs text-slate-300 leading-relaxed m-0 font-medium">
                    {item.problem}
                  </p>
                </motion.div>
              );
